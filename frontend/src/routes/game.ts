...
export async function createRoom(app: FastifyInstance){
    app.post('/create-game', async (req, reply) => {
        const body = req.body;
        const response = await fetch('http://localhost:3002/api/game/create-game', {
            method: 'POST',
...
export async function awaitforOpponent(app: FastifyInstance){
    app.post('/find-lobbies', async (req, reply) => {
        const body = req.body;
        const response = await fetch('http://localhost:3002/api/game/find-lobbies', {
            method: 'POST',
            headers: { 'Content-Type': 'application/json'},
            body: JSON.stringify(body),
        });
...
export async function joinLobby(app: FastifyInstance){
    app.post('/join-lobby', async (req, reply) => {
        const body = req.body;
        const response = await fetch('http://localhost:3002/api/game/join-lobby', {
            method: 'POST',
            headers: { 'Content-Type': 'application/json'},
            body: JSON.stringify(body),
        });
...
export async function inGame(app: FastifyInstance){
    app.post('/in-game', async (req, reply) => {
        const body = req.body;
        const response = await fetch('http://localhost:3002/api/game/in-game', {
            method: 'POST',
            headers: { 'Content-Type': 'application/json'},
            body: JSON.stringify(body),
        });
...
export async function historyGame(app: FastifyInstance){
    app.post('/history', async (req, reply) => {
        const body = req.body;
        const response = await fetch('http://localhost:3002/api/game/history', {
            method: 'POST',
            headers: { 'Content-Type': 'application/json'},
            body: JSON.stringify(body),
        });
...
export async function postGame(app: FastifyInstance){
    app.post('/end-game', async (req, reply) => {
        const body = req.body;
        const response = await fetch('http://localhost:3001/api/game/end-game', {
            method: 'POST',
            headers: { 'Content-Type': 'application/json'},
            body: JSON.stringify(body),
        });
